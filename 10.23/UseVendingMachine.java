...
class VendingMachine{
	...
	//	Items lastSelect = new Items(Items.getName(),Items.getSize(),Items.getPrice());
	//Drink giveDrink = new Drink(drink.getName(),drink.getPrice(), 1);
	//
	return select;
	}
...
class UseVendingMachine{
	public static void main(String[] args){
		...
		m1.deposit(100000);
		Items i1 = m1.select(VendingMachine.CHUNSIK);
		Items test =m1.select(VendingMachine.CHUNSIK);
		test.name = "a";
	}
}
